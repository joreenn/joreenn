...
| Category | Skills |
|----------|--------|
| **Frontend** | React, Next.js, JavaScript, Tailwind CSS, HTML5, CSS3, Vite |
| **Backend** | Node.js, Express.js, Laravel, PHP, REST APIs, JWT Auth |
| **Database** | MySQL, Schema Design, CRUD, Eloquent ORM |
